...
public interface PackageScheduleDetailsCustomRepository {
    ...
    Page<PackageScheduleDetails> findAvailableEarliestByPackageNameContaining(String name, Pageable pageable, String sort, Long mainCategoryId, Long subCategoryId, Long smallCategoryId );
